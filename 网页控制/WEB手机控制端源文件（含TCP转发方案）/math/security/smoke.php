...
<title>智能创客－烟雾火警</title>
<meta name="keywords" content="智能创客－烟雾火警" />
<meta name="description" content="智能创客－烟雾火警" />
		...
		<tr>
			...
			<?php 
				...
				while($row = mysql_fetch_array($result)) 
				{
					...
					$time=$row['time'];
					*/
					echo "烟雾火警：".$row[1]." 时间：".getTimeDifference($row[0])."<BR>";			
				}
			?>
			</td>            
		</tr>
...
<div style="padding: 0 8px"><button style="width: 100%" class="button2" onClick="javascript:window.location.href='?mode=list'" >查看烟雾火警记录</button></div><BR>
<div style="padding: 0 8px"><button style="width: 100%" class="button3" onClick="javascript:window.location.href='http://www.znck007.com/forum.php?mod=viewthread&tid=26812'" >烟雾火警DIY教程</button></div> 
